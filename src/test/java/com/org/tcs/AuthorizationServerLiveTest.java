...
public class AuthorizationServerLiveTest {
    ...
    public void whenServiceStartsAndLoadsRealmConfigurations_thenOidcDiscoveryEndpointIsAvailable() {
        final String oidcDiscoveryUrl = "http://localhost:8083/auth/realms/tcs/.well-known/openid-configuration";
    ...
    private String obtainAccessToken() {
        ...
        final String authorizeUrl = "http://localhost:8083/auth/realms/tcs/protocol/openid-connect/auth?response_type=code&client_id=fooClient&scope=read&redirect_uri=" + redirectUrl;
        final String tokenUrl = "http://localhost:8083/auth/realms/tcs/protocol/openid-connect/token";
